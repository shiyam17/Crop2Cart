...
//               child: Row(
//                 children: [
//                   buildCategoryCard(context, 'Tomato', 'assets/images/tomato.png', Colors.red.shade400, TomatoPage()),
//                   SizedBox(width: 16),
//                   buildCategoryCard(context, 'onion', 'assets/images/carrot.png', Colors.purple.shade200, OnionPage()),
//                   SizedBox(width: 16),
//                   buildCategoryCard(context, 'Potato', 'assets/images/potato.png', Colors.brown.shade300, PotatoPage()),
//                 ],
//               ),
//             ),
//             SizedBox(height: 24),
...
//               child: Row(
//                 children: [
//                   buildCategoryCard(context, 'Rice', 'assets/images/rice.png', Colors.grey.shade200, RicePage()),
//                   SizedBox(width: 16),
//                   buildCategoryCard(context, 'Wheat', 'assets/images/wheat.png', Colors.brown.shade200, WheatPage()),
//                   SizedBox(width: 16),
...
//                   SizedBox(width: 16),
//                   buildCategoryCard(context, 'Pulses', 'assets/images/pulses.png', Colors.grey.shade200, RicePage()),
//                 ],
//               ),
//             ),
//           ],
...
//             Navigator.push(
//               context,
//               MaterialPageRoute(builder: (context) => LanguageSelectionScreen()), // Navigate to CartScreen from buy.dart
//             );
//           }
...
//       body: Center(child: Text('Details about Carrot')),
//     );
//   }
// }
...
import 'package:flutter/material.dart';
import 'package:c2c/pages/onion.dart';
// Ensure this is the correct import path for language settings
...
class Chome extends StatelessWidget {
          ...
          IconButton(
            ...
            onPressed: () {
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        Rprofile()), // Ensure ProfilePage is defined
              );
            },
          ),
        ],
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.pop(
                    context); // Close the drawer and stay on the home page
              },
            ),
            ListTile(
              leading: Icon(Icons.account_circle),
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          SettingsPage()), // Ensure SettingsPage is defined
                );
              },
            ),
            ListTile(
              ...
              title: Text('Logout'),
              onTap: () {
                // Handle logout (e.g., navigate to login screen or clear user session)
        ...
        child: ListView(
          children: [
              ...
              child: Row(
                children: [
                  buildCategoryCard(
                      ...
                      TomatoPage()),
                  SizedBox(width: 16),
                  buildCategoryCard(context, 'Onion', 'assets/images/onion.png',
                      Colors.purple.shade200, OnionPage()),
                  SizedBox(width: 16),
                  buildCategoryCard(
                      context,
                      'Potato',
            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: [
                  buildCategoryCard(context, 'Rice', 'assets/images/rice.png',
                      Colors.grey.shade200, RicePage()),
                  SizedBox(width: 16),
                  buildCategoryCard(context, 'Wheat', 'assets/images/wheat.png',
                      Colors.brown.shade200, WheatPage()),
                  SizedBox(width: 16),
                  buildCategoryCard(context, 'Sugar', 'assets/images/sugar.png',
                      Colors.grey.shade200, RicePage()),
                  SizedBox(width: 16),
                  buildCategoryCard(context, 'Salt', 'assets/images/salt.png',
                      Colors.grey.shade200, RicePage()),
                  SizedBox(width: 16),
                  buildCategoryCard(
                      context,
  ...
  Widget buildCategoryCard(BuildContext context, String title, String imagePath,
      Color backgroundColor, Widget nextPage) {
    return InkWell(
      onTap: () {
        Navigator.push(
          context,
